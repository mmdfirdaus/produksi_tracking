<?php
// (Nama file baru: rincian_laporan.php - UNTUK ADMIN)

// [DIUBAH] Menggunakan header admin
    ...
    <div class="d-flex align-items-center gap-2 text-muted">
        ...
        <span><i class="bi bi-hash"></i> SPK: <?php echo htmlspecialchars($header_info['no_spk']); ?></span>
            ...
            <div class="d-flex flex-wrap gap-2">
                <a href="laporan_detail.php?id_barang=<?php echo $header_info['id_barang']; ?>" class="btn btn-secondary">
        ...
        <div class="modal-content" style="border-radius: 16px; background: var(--glass-bg); backdrop-filter: blur(20px);">
            ...
            <div class="modal-body">
                ...
                <?php if (empty($all_months_for_download)): ?>
                    <p class="text-muted text-center small mt-2">Download Laporan Bulanan tidak tersedia karena tidak ada data laporan harian yang tercatat.</p>
                <?php endif; ?>
            </div>
