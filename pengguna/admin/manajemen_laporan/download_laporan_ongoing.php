...
// Jika form mengirim array (checkbox), ambil index 0. Jika string, pakai langsung.
$post_bulan = isset($_POST['bulan_laporan']) ? $_POST['bulan_laporan'] : '';
$bulan_laporan = is_array($post_bulan) ? $post_bulan[0] : $post_bulan;
