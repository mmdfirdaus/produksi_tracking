...
try {
    ...
    <head>
        ...
        <style>
            @page { margin: 20px; }
            body { font-family: "Helvetica", "Arial", sans-serif; font-size: 8px; margin: 0; }
            .container { width: 100%; }
            .header-title { text-align: center; font-size: 14px; font-weight: bold; margin-bottom: 5px; color: #333; }
            .header-subtitle { text-align: center; font-size: 12px; font-weight: normal; margin-bottom: 15px; color: #555; }
            .table-header { width: 100%; border-collapse: collapse; margin-bottom: 15px; }
            .table-header th, .table-header td { border: 1px solid #555; padding: 4px; text-align: left; vertical-align: top; font-size: 9px; }
            .table-header th { background-color: #f0f0f0; font-weight: bold; width: 20%; }
            .alur-title { font-size: 11px; font-weight: bold; color: #333; background-color: #DDEBF7; padding: 5px; margin-top: 10px; margin-bottom: 3px; border: 1px solid #999; page-break-after: avoid; }
            .alur-title span { font-weight: normal; color: #004a99; }
            .table-komponen { width: 100%; border-collapse: collapse; page-break-inside: auto; }
            .table-komponen th, .table-komponen td { border: 1px solid #888; padding: 3px 4px; text-align: center; }
            .table-komponen th { background-color: #4472C4; color: white; font-weight: bold; font-size: 8px; padding: 4px; }
            .table-komponen td.text-left { text-align: left; padding-left: 5px; }
            .table-komponen td.daily-data { font-weight: bold; color: #004a99; }
