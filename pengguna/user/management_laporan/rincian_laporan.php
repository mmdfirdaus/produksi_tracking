<?php
// (Nama file baru: rincian_laporan.php)
...
try {
    ...
    // 4. TAB RINGKAS - Query (Sama seperti material.php)
    $sql_ringkas = "
        SELECT
            tm.id_material,
            mk.nama_komponen,
            ...
            'Selesai' AS status_pengerjaan, -- Status di-hardcode Selesai
    ...
    // $avg_progress (tidak relevan, pasti 100%)

    // 5. TAB DETAIL - Query untuk bulan terpilih (Sama seperti material.php)
    $sql_detail = "
         SELECT
            tm.id_material,
            mk.nama_komponen,
                    ...
                    <div class="alur-card">
                        <div class="alur-header" onclick="toggleAlur(this)">
                            ...
                            <div class="alur-badges">
                                <span class="status-badge status-success"> Selesai
                                </span>
                                ...
                                <tbody>
                                    <?php $no = 1; foreach ($data_alur['items'] as $mat): ?>
                                        <?php
                                            ...
                                            $progress_class = 'bg-success'; // Selalu success
                                        ?>
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php $no = 1; foreach ($data_alur['items'] as $mat): ?>
                                            <?php
                                                ...
                                                // Note: Sisa & Persen di sini adalah sisa & persen HANYA PADA BULAN INI
