...
include_once __DIR__ . '/../../../templates/header_user.php';

// Pastikan pengguna sudah login dan rolenya adalah 'user'
...
// Jika pengguna tidak ditemukan, handle error
if (!$user) {
...
<head>
    ...
    <title>Pengaturan Akun - User</title>
...
<div class="settings-container">
    ...
    <div class="page-header">
        <h1><i class="bi bi-gear-fill"></i> Pengaturan Akun</h1>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    passwordBaru.addEventListener('input', function() {
        ...
        if (value.length > 0 && value.length < 6) {
            ...
            // Re-validate konfirmasi if it has value
    ...
    form.addEventListener('submit', function(e) {
        ...
        // If password change is attempted, validate password fields
