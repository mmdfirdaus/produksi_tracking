...
// Periksa apakah pengguna sudah login dan rolenya adalah 'user'
...
<head>
    ...
    <title><?php echo isset($page_title) ? htmlspecialchars($page_title) : 'Dashboard'; ?> - User</title>
    ...
    <style>
        /* ========================================= */
        /* ROOT VARIABLES - Consistent with Admin */
        /* ========================================= */
        :root {
        ...
        /* ========================================= */
        /* BODY BACKGROUND - Consistent with Admin */
        /* ========================================= */
        body {
            padding-top: 80px;
        ...
        /* ========================================= */
        /* NAV LINKS - No Dropdowns, Independent Items */
        /* ========================================= */
        .navbar-nav .nav-link {
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?php echo $base_url; ?>/pengguna/user/dashboard.php" aria-label="Dashboard">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo $base_url; ?>/pengguna/user/dashboard.php">
                            <i class="bi bi-speedometer2"></i> Dashboard
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo $base_url; ?>/pengguna/user/management_produksi/master_barang.php">
                            <i class="bi bi-box-seam"></i> Master Barang
                        </a>
                    </li>
                    
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo $base_url; ?>/pengguna/user/management_laporan/laporan.php">
                            <i class="bi bi-file-earmark-text"></i> Laporan Produksi
                        </a>
                    </li>
                </ul>
                ...
                <div class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <li>
        <a class="dropdown-item" href="<?php echo $base_url; ?>/pengguna/user/pengaturan/pengaturan.php">
    ...
    <!-- JavaScript untuk navbar functionality -->
    <!-- Logout confirmation ditangani oleh footer.php -->
    <script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        navLinks.forEach(link => {
            // Skip dropdown toggle (user profile)
